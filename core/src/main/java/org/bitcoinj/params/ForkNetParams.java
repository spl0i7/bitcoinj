 ...
 */
public class ForkNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public ForkNetParams() {
        super();
        interval = INTERVAL;
        ...
        httpSeeds = new HttpDiscovery.Details[] {
                new HttpDiscovery.Details(ECKey.fromPublicOnly(Utils.HEX.decode("027a79143a4de36341494d21b6593015af6b2500e720ad2eda1c0b78165f4f38c4")),
        ...
        addrSeeds = new int[] {0x9F598BF6,0x9F598120,0xA5E3323E};
    }

    private static ForkNetParams instance;
    public static synchronized ForkNetParams get() {
        if (instance == null) {
            instance = new ForkNetParams();
        }
        return instance;
    }
